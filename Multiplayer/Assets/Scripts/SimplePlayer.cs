...
public class SimplePlayer : NetworkBehaviour
{
    ...
    public override void FixedUpdateNetwork()
    {
        ...
        {
            Quaternion camerYawRotation = Quaternion.Euler(0.0f, inputData.cameraYaw, 0.0f);

            Vector3 forward = camerYawRotation * Vector3.forward;
            Vector3 right = camerYawRotation * Vector3.right;
